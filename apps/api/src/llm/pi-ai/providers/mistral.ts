...
// @ts-ignore – package ships ESM-only subpath types resolved only by moduleResolution nodenext
import type { ChatCompletionStreamRequest, ChatCompletionStreamRequestMessage, CompletionEvent, ContentChunk, FunctionTool } from "@mistralai/mistralai/models/components";
